...
const DataEnrichmentSender = ({ quesAsked, setDeDisplay }) => {
  //API KEY
  ...
  }, [ansEatChocolates, ansHaveChoclairs, ansEnjoyChoclairs, currentQuestion]);
      ...
      <div className="w-full absolute top-0 left-0 z-[99999]  purpleBackgroundColor h-[100vh]">
        ...
        <div className="z-[99999] h-[100vh] flex-col flex items-start mt-[50px]">
          <div className="mx-auto">
            <div className="text-center flex flex-col items-center gap-[20px] w-[100vw]">
              <BigHeadTitle
                style="bigHeadTitle text-[2.1953896816684964vh]"
                bigHeadTitle="Here's a chance to up"
                bigHeadTitle2="your Meter by 5%!"
              />
              <span className="txtDescription text-white text-[14px] block">
                Just answer this for us.
              </span>
              <HeadTitle
                style="font-bold text-[1.9758507135016465vh]"
                headTitle={
                  currentQuestion === 1
              ...
              />
              <ul className="list-unstyled listRadio mx-auto w-[75%]">
                <li>
...
export default DataEnrichmentSender;
